    ...
    const Gig = () => {
        return (
            <div className="flex flex-col items-center justify-center mt-8"> {/* Added margin top */}
                <div className="gig-container border border-black rounded-lg p-8 mb-8 w-96">
                    ...
                    <div className="gigtitle mb-4">
                        ...
                        <input type="text" id="1" placeholder="Enter your Gig title" className="border-black border min-w-full px-4 py-2 rounded"></input> {/* Rounded edges */}
                    </div>
                    <div className="gigcat mb-4">
                        <label htmlFor="2" className="block">Gig Category</label>
                        <input type="text" id="2" placeholder="Enter your Gig Category" className="border-black border min-w-full px-4 py-2 rounded"></input> {/* Rounded edges */}
                    </div>
                    <div className="gigsearch mb-4">
                        <label htmlFor="3" className="block">Search tags</label>
                        <input type="text" id="3" placeholder="Enter Search Tags" className="border-black border min-w-full px-4 py-2 rounded"></input> {/* Rounded edges */}
                    </div>
                    <div className="gigdes mb-4">
                        <label htmlFor="4" className="block">Description</label>
                        <input type="text" id="4" placeholder="enter Description" className="border-black border min-w-full px-4 py-2 rounded"></input> {/* Rounded edges */}
                    </div>
                    <div className="gigperv mb-8">
                        <div className="">
                            <label htmlFor="5" className="block">Previous Works</label>
                            <input className="border border-black p-4 w-full px-4 py-2 rounded" type="file" id="5" accept="image/png, image/jpeg"></input> {/* Rounded edges */}
                        </div>
                    </div>
