  ...
  const Book = () => {
    return (
      <div className="flex justify-center items-center mt-8"> {/* Full width */}
        <div className="w-3/5 h-3/5 p-8 border border-black rounded-lg mr-8 pb-4"> {/* Increased width and added padding bottom */}
          <div className="Appointment">
            <div>
              <h1 className="text-2xl font-bold mb-8">Book Appointment</h1> {/* Increased font size */}
            </div>
            <div className="w-1/2 mb-4">
              <input type="date" placeholder="Choose Date" className="mb-4 border border-black rounded p-2 w-full"></input>
            </div>
            <div className="w-1/2 mb-4">
              <input type="text" placeholder="Input the Google Map Location" className="mb-4 border border-black rounded p-2 w-full"></input>
            </div>
            <div className="w-1/2 h-48 mb-4">
              <textarea placeholder="Work Description" className="mb-4 border border-black rounded p-2 w-full h-full"></textarea> {/* Increased height */}
            </div>
          </div>
        </div>
